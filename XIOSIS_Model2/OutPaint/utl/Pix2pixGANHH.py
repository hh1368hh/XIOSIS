...
class Pix2PixModel(BaseModel):
    def __init__(self,input_nc=6,output_nc=3,is_train=True,norm='batch',netG='unet_128',netD='basic',pool_size=0, gan_mode='vanilla',gpu_ids=[0]):
        opt=defaults()
        ...
        opt.norm=norm
        opt.netG=netG #specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | unet_512]
