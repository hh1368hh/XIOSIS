...
class CTGAN(Base_Model):
  ...
  def backward_G(self,retain_graph=False):
    ...
    if spc_con_lambda >0:
      ...
      self.loss_spc_con = self.criterionSpcCon(torch.sigmoid((self.G_fake_D-2300)/25)*3000,torch.sigmoid((self.G_real_D-2300)/25)*3000) * spc_con_lambda
