...
def ResizePatientVar512(original_CT):
    desired_spacing=[1,1,1]
    desired_spacing [0]=(original_CT.GetSize()[0] * original_CT.GetSpacing()[0] ) /512
    desired_spacing [1]=(original_CT.GetSize()[1] * original_CT.GetSpacing()[1] ) /512
    ...
    reference_size=(round(size[0] * spacing[0] / desired_spacing[0]),round(size[1] * spacing[1] / desired_spacing[1]),round(size[2] * spacing[2] / desired_spacing[2]))
